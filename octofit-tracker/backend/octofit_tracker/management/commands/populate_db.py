...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        Activity.objects.create(user='superman', activity_type='Swimming', duration=60, team='DC')
        Activity.objects.create(user='captainamerica', activity_type='Walking', duration=20, team='Marvel')
